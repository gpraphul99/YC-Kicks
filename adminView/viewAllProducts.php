...
<div >
  ...
  <table class="table table-striped ">
    ...
    <tr>
      ...
      <td><button class="btn btn-primary" onclick="itemEditForm('<?=$row['product_id']?>')">Edit</button></td>
      <td><button class="btn btn-danger" onclick="itemDelete('<?=$row['product_id']?>')">Delete</button></td>
      </tr>
      <?php
            $count=$count+1;
          }
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form  enctype='multipart/form-data' onsubmit="addItems()" method="POST">
            ...
            <div class="form-group">
              <button type="submit" class="btn btn-success" id="upload" style="height:40px">Add Item</button>
            </div>
          </form>
