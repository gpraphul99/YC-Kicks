...
<div >
  ...
  <table class="table ">
    ...
    <tr>
      ...
      <td><button class="btn btn-danger" onclick="categoryDelete('<?=$row['category_id']?>')">Delete</button></td>
      </tr>
      <?php
            $count=$count+1;
          }
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form  enctype='multipart/form-data' action="./controller/addCatController.php" method="POST">
            ...
            <div class="form-group">
              <button type="submit" class="btn btn-success" name="upload" style="height:40px">Add Category</button>
            </div>
          </form>
